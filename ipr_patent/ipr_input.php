<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        if (isset($_FILES['app_form_file']['name']))
        {
          ...
          $insertquery ="INSERT INTO ipr_patent_details (first_name, middle_name, last_name,patent_office, ipr_type, number, design_no, date, team_1, team_2, team_3, club, date_of_issue, date_of_renew, app_form_file, status)
          VALUES ('$first_name', '$middle_name', '$last_name',  '$patent_office', '$ipr_type', $number, '$design_no', '$date', '$team_1', '$team_2', '$team_3', '$club', '$date_of_issue', '$date_of_renew', '$app_form_file',1)";

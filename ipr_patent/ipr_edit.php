    ...
    <div class="form">
        ...
        // include('db_connect.php');
            ...
            if(isset($_POST['submit']) && $status==1)
            {
                ...
                $id1 = $_POST['spe_id'];
                $update="UPDATE ipr_patent_details SET first_name='$first_name', middle_name='$middle_name' , last_name='$last_name',patent_office='$patent_office', ipr_type='$ipr_type', design_no='$design_no', date='$date', team_1='$team_1', team_2='$team_2', team_3='$team_3', club='$club', date_of_issue='$date_of_issue', date_of_renew='$date_of_renew' WHERE id=$id1"; 
            ...
            <form method="POST" action="">
                ...
                <table class="form_table">
                    <tr>
                        ...
                        <td><input type="text" name="faculty_id" class="t_field"
                                value="<?php echo $row['faculty_id'];?>"></td> -->
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="design_no" class="t_field" value="<?php echo $row['design_no'];?>">
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input type="date" name="date_of_issue" class="t_field"
                                value="<?php echo $row['date_of_issue'];?>"></td>
                    </tr>

                    <tr>
                        <th><label>Date of Renew</label></th>
                        <td><input type="date" name="date_of_renew" class="t_field"
                                value="<?php echo $row['date_of_renew'];?>"></td>
                        <th><label>Application Form(Pdf)</label></th>
                        <td><input type="file" name="app_form_file" class="t_field"
                                value="<?php echo $row['app_form_file'];?>"></td>
                    </tr>
                </table>

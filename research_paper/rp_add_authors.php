...
<body>
    ...
    <div class="container">
        <a href="rp_output.php"><button class="back_btn" style="margin-left:70%;">Back</button></a>
    </div>
        ...
        <form method="POST" action="rp_author_input.php">
            <table class="form_table" style="margin-left:15%;">
                <tr>
                    ...
                    <td><input type="text" name="first_name" class="t_field"><br></td>
                </tr>
                <th><label>Middle Name</label></th>
                <td><input type="text" name="middle_name" class="t_field"><br></td>
                </tr>
                <tr>
                    <th><label>Last Name</label></th>
                    <td><input type="text" name="last_name" class="t_field"><br></td>
                </tr>
                <tr>
                    <th><label>Email</label></th>
                    <td><input type="text" name="email" class="t_field"><br></td>
                </tr>
                <tr>
                    <th><label>Research Paper Name</label></th>
                    <td><input type="text" name="research_paper_name" class="t_field"><br></td>
                </tr>
                <tr>
                    <th><label>Department</label></th>
                    <td><input type="text" name="department" class="t_field"><br></td>
                </tr>
                <tr>
                    <th><label>University</label></th>
                    <td><input type="text" name="university" class="t_field"><br></td>
                </tr>
                <tr>

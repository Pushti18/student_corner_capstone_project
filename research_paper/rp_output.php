            ...
            $('#details_table').dataTable({
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, title, type, row) {
                            if (session_id == "1327") {
                                return '<td><form action="rp_view.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                    '></input><textarea   style="width:30px;" name="title" hidden>' +
                                    type.title_article +
                                    '</textarea><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                    '></input><input type="submit" value="View"></form></td><td><form action="rp_edit.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                    '></input><input type="submit" value="Edit"></form></td> <td><form action="rp_delete.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                ...
                                return '<td><form action="rp_view.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    ...
                                    '></input><textarea   style="width:30px;" name="title" hidden>' +
                                    type.title_article +
                                    '</textarea><input type="submit" value="View"></form></td>';
                            }
                ...
                buttons: [{
                    ...
                    },
                    {
                        ...
                        filename: 'Research Paper Details'
                    },
                    'pageLength'
                ],
            });

...
session_start();
    ...
    $id=$_REQUEST['id'];
    $query = "SELECT * from student_participation_details where id='".$id."'"; 
            ...
            <form method="POST" action="">
                <table class="form_table">
                    <tr>
                        ...
                        <td><input type="text" name="first_name" class="t_field"
                                value="<?php echo $row['first_name'];?>"></td>
                    </tr>
                    <br>
                    <tr>
                        <th><label>Middle Name</label></th>
                        <td><input type="text" name="middle_name" class="t_field"
                                value="<?php echo $row['middle_name'];?>"></td>
                        <th><label>Last Name</label></th>
                        <td><input type="text" name="last_name" class="t_field" value="<?php echo $row['last_name'];?>">
                        </td>
                    </tr>

                    <tr>
                        <th><label>GR no.</label></th>
                        <td><input type="number" name="emp_id" class="t_field" value="<?php echo $row['emp_id'];?>">
                        </td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="title_of_event" class="t_field"
                                value="<?php echo $row['title_of_event'];?>"></td>
                        <th><label>Organised by</label></th>
                        <td><input type="text" name="organised_by" class="t_field"
                                value="<?php echo $row['organised_by'];?>"></td>
                    </tr>

                    <tr>
                        <th><label>Organised at</label></th>
                        <td><input type="text" name="organised_at" class="t_field"
                                value="<?php echo $row['organised_at'];?>"></td>
                    ...
                    <tr>
                        ...
                        <td><input type="text" name="country" class="t_field" value="<?php echo $row['country'];?>">
                        </td>
                    </tr>

                    <tr>
                        <th><label>Start date</label></th>
                        <td><input type="date" name="start_date" class="t_field"
                                value="<?php echo $row['start_date'];?>"></td>
                        <th><label>End Date</label></th>
                        <td><input type="date" name="end_date" class="t_field" value="<?php echo $row['end_date'];?>">
                        </td>
                    </tr>

                    <tr>
                        <th><label>In collaboration by</label></th>
                        <td><input type="text" name="in_collab_by" class="t_field"
                                value="<?php echo $row['in_collab_by'];?>"></td>
                        <th><label>No. of days</label></th>
                        <td><input type="number" name="no_of_days" class="t_field"
                                value="<?php echo $row['no_of_days'];?>"></td>
                    </tr>

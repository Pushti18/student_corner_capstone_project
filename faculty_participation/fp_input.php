<?php
    ...
    if(isset($_POST['submit']))
    {
        ...
        for($i = 0; $i < $event_img_count; $i++){
          ...
          $insertquery ="INSERT INTO student_participation_details( first_name, middle_name , last_name, emp_id, event, title_of_event, organised_by, organised_at, city, state, country, start_date, end_date, in_collab_by, no_of_days, level, mode, status) 
          VALUES ('$first_name', '$middle_name', '$last_name', '$emp_id', '$event', '$title_of_event', '$organised_by', '$organised_at', '$city', '$state','$country', '$start_date', '$end_date', '$in_collab_by', '$no_of_days', '$level', '$mode', 1)";
          // $iquery = mysqli_query($conn, $insertquery);
            ...
            $getEventId = "SELECT MAX(id) as id FROM student_participation_details";

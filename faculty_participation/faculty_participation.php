...
<body>
    ...
    <h2 style="margin-left:37%;">Student Participation Details Entry</h2>
    <div class="container">
        ...
        <form method="POST" action="fp_input.php" enctype="multipart/form-data">
            <table class="form_table">
                ...
                <tr>
                    ...
                    <td><input type="number" name="emp_id" class="t_field"
                            onKeyDown="if(this.value.length==6 && event.keyCode!=8) return false;"></td>
            ...
            <p style="margin-left:5%; font-size:15px;"><b>Request to enter all the details and if its not available
                    currently, then put "-" as the value. Also you can select multiple files from one option by
                    selecting them altogether.</b></p>

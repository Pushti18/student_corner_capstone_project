...
<body>
    ...
    <div class="nav_div" style="background-color:lightblue;">
        <h2 style="margin-left:40%;">Student Participation Details</h2>
    </div>
                ...
                "columns": [{
                    ...
                    },
                    {
                        ...
                        render: function(data, title, type, row) {
                            if (session_id == "1327") {
                                return '<td><form action="fp_view.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                    '></input><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                    '></input><input type="submit" value="View"></form></td><td><form action="fp_edit.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
                                    '></input><input type="submit" value="Edit"></form></td> <td><form action="fp_delete.php" method="POST"><input type="hidden"  style="width:30px;" name="id" value=' +
                                    data +
